      ...
      <div className="w-full max-w-md p-8" style={{ background: '#0F131C', borderRadius: 'var(--radius-lg)' }}>
        ...
        <div className="relative my-6">
          <div className="absolute inset-0 flex items-center">
            <div className="w-full border-t" style={{ borderColor: '#161D2B' }}></div>
          </div>
          <div className="relative flex justify-center text-sm">
            <span className="px-4 text-gray-400" style={{ background: '#0F131C' }}>Or continue with</span>
          </div>
        </div>
        ...
        <button
          ...
          disabled={isLoading}
          className="w-full py-3 rounded-pill font-medium border transition-all hover:opacity-90"
          style={{ background: '#161D2B', borderColor: '#1E2636', color: '#ffffff' }}
        >
        ...
        <p className="text-center mt-6 text-sm text-gray-400">
          ...
          <a href="/register" className="font-medium hover:underline" style={{ color: '#38BDF8' }}>
            Sign up
          </a>
        </p>
      </div>
